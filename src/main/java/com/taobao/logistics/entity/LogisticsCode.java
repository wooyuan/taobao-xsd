...
@Data
@Entity
@Table(name = "M_LOGISTICS_CODE", schema = "NEANDS3")
public class LogisticsCode {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_M_LOGISTICS_CODE")
    @SequenceGenerator(sequenceName = "SEQ_M_LOGISTICS_CODE", name = "SEQ_M_LOGISTICS_CODE", allocationSize = 1)
    private int id;
