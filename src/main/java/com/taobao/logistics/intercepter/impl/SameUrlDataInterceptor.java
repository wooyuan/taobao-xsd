package com.taobao.logistics.intercepter.impl;

import com.alibaba.fastjson.JSONObject;
import com.taobao.logistics.intercepter.RepeatSubmit;
import com.taobao.logistics.intercepter.RepeatSubmitInterceptor;
    ...
    public boolean isRepeatSubmit(HttpServletRequest request, RepeatSubmit annotation)
    {
        ...
        if (sessionObj != null)
        {
            ...
            if (sessionMap.containsKey(url))
            {
                ...
                System.out.println("preDataMap===" + preDataMap.toString());
